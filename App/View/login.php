                ...
                <div class="col-lg-6 login_box_criarconta">
                    <div class="mt-3">
                        <div class="hover">
                            ...
                            <a class="btn btn-outline-primary" href="<?= baseUrl() ?>Home/criarNovaConta">Crie sua conta aqui</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login_form_inner">
                        ...
                        <form method="POST" class="row login_form" action="#" id="contactForm">
                            ...
                            <div class="col-md-12 form-group">
                                <div class="alert alert-danger" role="alert">
                                    Aqui colocar mensagem de error..
                                </div>
                            </div>
                            <div class="col-md-12 form-group">
