                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="<?= baseUrl() ?>uploads/produtos/product-1.jpg" style="width: 100px; height: 100px" alt="">
                                    </div>
                        ...
                        <tr>
                            <td>
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="<?= baseUrl() ?>uploads/produtos/product-2.jpg" style="width: 100px; height: 100px" alt="">
                                    </div>
                                    <div class="media-body">
                                        <p>Minimalistic shop for multipurpose use</p>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="<?= baseUrl() ?>uploads/produtos/product-3.jpg" style="width: 100px; height: 100px" alt="">
                                    </div>
                                    <div class="media-body">
                                        <p>Minimalistic shop for multipurpose use</p>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="d-flex text-right">
                                    <a class="btn btn-outline-secondary btn-sm" href="<?= baseUrl() ?>">Continue comprando</a>
                                    <a class="btn btn-outline-secondary btn-sm ml-2" href="<?= baseUrl() ?>Home/carrinhoPagamento">Pagamento</a>
                                </div>
                            </td>
                        </tr>
                    </tbody>
