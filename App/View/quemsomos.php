...
<div class="container">
    ...
    <div class="single-blog-wrapper">
        ...
        <div class="single-blog-post-thumb">
            <img src="<?= baseUrl() ?>uploads/quemsomos/bg-8.jpg" alt="">
        </div>
                ...
                <div class="col-12 col-md-10">
                    <div class="regular-page-content-wrapper section-padding-80">
                        <div class="regular-page-text">
                            ...
                            <p>
                                Dai nasce a <a href="<?= baseUrl() ?>" class="quemsomos-link-empresa"><strong>Essence Moda</strong></a> uma empresa que visa revolucionar o mercado de vendas online dando a todos uma experiência única em compras virtuais.
                            </p>
                        </div>
                    </div>
                </div>
